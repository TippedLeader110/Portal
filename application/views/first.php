  ...
  <?php if (sizeof($post)==3): ?>
    <?php $ulang=1; ?>
      <div class="col-6" style="padding: 0px 0px 0px 10px">
        ...
        <div class="bottom-left"><h4 style="color: white"><?php echo $post[0]->judul ?></h4></div>
      </div>
      </div>
      <div class="col-6" style="padding: 0px 0px 0px 0px">
        ...
        <div class="bottom-left"><h4 style="color: white"><?php echo $post[2]->judul ?></h4></div>
      </div>
      </div>
      <div class="col-12">
        <div class="img-wrapper">
        ...
        <div class="bottom-left"><h4 style="color: white"><?php echo $post[1]->judul ?></h4></div>
      </div>
      </div>
      </div>
  <?php endif ?>
