...
--
-- Temporary table structure for view `jumlah_fitur`
--

DROP TABLE IF EXISTS `jumlah_fitur`;
/*!50001 DROP VIEW IF EXISTS `jumlah_fitur`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `jumlah_fitur` (
  `jumlah_fitur` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `jumlah_guru`
--

DROP TABLE IF EXISTS `jumlah_guru`;
/*!50001 DROP VIEW IF EXISTS `jumlah_guru`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `jumlah_guru` (
  `jumlah_guru` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `jumlah_navbar`
--

DROP TABLE IF EXISTS `jumlah_navbar`;
/*!50001 DROP VIEW IF EXISTS `jumlah_navbar`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `jumlah_navbar` (
  `jumlah_navbar` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `jumlah_post`
--

DROP TABLE IF EXISTS `jumlah_post`;
/*!50001 DROP VIEW IF EXISTS `jumlah_post`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `jumlah_post` (
  `jumlah_post` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `jumlah_siswa`
--

DROP TABLE IF EXISTS `jumlah_siswa`;
/*!50001 DROP VIEW IF EXISTS `jumlah_siswa`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `jumlah_siswa` (
  `jumlah_siswa` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `jumlah_tema`
--

DROP TABLE IF EXISTS `jumlah_tema`;
/*!50001 DROP VIEW IF EXISTS `jumlah_tema`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `jumlah_tema` (
  `jumlah_tema` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `navitem` VALUES (1,1,'item','green','pertama','pertama'),(3,3,'item','kedua','kedua','kuda'),(4,4,'item','green','ketiga','pertama'),(2,2,'drop','kedua','keempat','kuda');
...
INSERT INTO `user` VALUES (1,'admin','','admin'),(2,'Muhammad Bayhaqi Daulay','bayhaqi','5b75bd843edb24b0ace1d5eba6625272');
...
--
-- Final view structure for view `jumlah_fitur`
--

/*!50001 DROP TABLE IF EXISTS `jumlah_fitur`*/;
/*!50001 DROP VIEW IF EXISTS `jumlah_fitur`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jumlah_fitur` AS select count(0) AS `jumlah_fitur` from `fitur` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `jumlah_guru`
--

/*!50001 DROP TABLE IF EXISTS `jumlah_guru`*/;
/*!50001 DROP VIEW IF EXISTS `jumlah_guru`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jumlah_guru` AS select count(0) AS `jumlah_guru` from `guru` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `jumlah_navbar`
--

/*!50001 DROP TABLE IF EXISTS `jumlah_navbar`*/;
/*!50001 DROP VIEW IF EXISTS `jumlah_navbar`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jumlah_navbar` AS select count(0) AS `jumlah_navbar` from `navitem` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `jumlah_post`
--

/*!50001 DROP TABLE IF EXISTS `jumlah_post`*/;
/*!50001 DROP VIEW IF EXISTS `jumlah_post`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jumlah_post` AS select count(0) AS `jumlah_post` from `post` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `jumlah_siswa`
--

/*!50001 DROP TABLE IF EXISTS `jumlah_siswa`*/;
/*!50001 DROP VIEW IF EXISTS `jumlah_siswa`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jumlah_siswa` AS select count(0) AS `jumlah_siswa` from `siswa` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `jumlah_tema`
--

/*!50001 DROP TABLE IF EXISTS `jumlah_tema`*/;
/*!50001 DROP VIEW IF EXISTS `jumlah_tema`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `jumlah_tema` AS select count(0) AS `jumlah_tema` from `tema` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
